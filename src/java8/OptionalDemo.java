...
public class OptionalDemo {
  ...
  public static void main(String[] args) {
    ...
    nameOptional
        .ifPresent(nameValue -> System.out.println("Name optional contains value => " + nameValue));
    ...
    numberOptional.filter(numValue -> numValue > 10).filter(numValue -> numValue < 20)
        .ifPresentOrElse(
            (numValue) -> System.out
                .println("Number optional is present within range => " + numValue),
