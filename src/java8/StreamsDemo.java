...
public class StreamsDemo {
  ...
  public static void main(String[] args) {
    ...
    numbers.stream().filter(num -> num % 2 == 0).map(num -> num.toString())
        .map(num -> sb.append(" " + num)).collect(Collectors.toList());
    System.out.println("All the numbers: " + sb.toString());
    ...
    System.out.println("Sum of even numbers is: " + numbers.stream().filter(num -> num % 2 == 0)
