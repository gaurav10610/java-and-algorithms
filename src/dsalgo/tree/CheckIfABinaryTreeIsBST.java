...
public class CheckIfABinaryTreeIsBST {
	...
	public static boolean isBST(TreeNode root, int min, int max) {
		...
		if (root == null) {
			...
			/**
			 * recursively check if left subtree is BST or not with appropriate min and max
			 * value bounds
			 */
			boolean isLeftSubtreeBST = isBST(root.getLeftChild(), min, root.getValue());

			/**
			 * recursively check if right subtree is BST or not with appropriate min and max
			 * value bounds
			 */
