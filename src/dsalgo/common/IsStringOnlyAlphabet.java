...
public class IsStringOnlyAlphabet {
	...
	public static void main(String[] args) {
		...
		System.out.println(isOnlyAlphabet(string1) ? "String1 is only alphabets" : "String1 is not only alphabets");

		System.out.println(isOnlyAlphabet(string2) ? "String2 is only alphabets" : "String2 is not only alphabets");
	}
