...
public class QueueUsingStack<T> {
  ...
  /**
   * 
   * removes and returns the element from head of the queue else null if queue is empty
   */
  public T poll() {
  ...
  /**
   * 
   * returns the element from head of the queue without removing it else null if queue is empty
   */
  public T peek() {
