...
public class MinimumDistanceBetweenTwoNodesInGraph {
	...
	public static void main(String[] args) {
		...
		if (result) {
			...
			System.out.print("Minimum distance between " + node1 + " and " + " node2 is: " + distance[node2]);
		} else {
	...
	public static boolean findDistanceBetweenNodes(MyUnweightedGraph graph, int node1, int node2, int totalNodes,
