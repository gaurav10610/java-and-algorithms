...
/**
 * 
 * Given a list of fish sizes and their direction of swim in a tank, find out which all fishes will
 * not get eaten up once the fish fight is over
 * 
 * 1. A fish will get eaten up in the fight only if there is some bigger fish swimming in the
...
public class FishFight {
  ...
  /**
   * return the sizes of all the fishes along with their direction of swim after the fish fight
   * 
   * @param fishSizes
   * @param swimDirection
   * @return
  ...
  public static Object[] getRemainingFishesAfterFight(int[] fishSizes, int[] swimDirection) {
    ...
    for (int i = 0; i < fishSizes.length; i++) {
      ...
      if (swimDirection[i] == -1) {
        ...
        /**
         * if fish is swimming in the left direction then check in the left of the fish for any
         * bigger fish swimming in the right direction
         * 
         */
        int j = i - 1;
        while (j >= 0) {
        ...
        /**
         * if fish is swimming in the right direction then check in the right of the fish for any
         * bigger fish swimming in the left direction
         * 
         */
        int j = i + 1;
      ...
      /**
       * if fish will not get eaten up at the end of the fight then keep it in the result set
       * 
       */
      if (!isEaten) {
