...
/**
 * 
 * Given a matrix of size M*N. Find the row with maximum number of zeroes given
 * that in a row all the zeroes will appear only after all the ones.Refer below
 * example
 * 
 ...
 * Output -> 3
 * 
 * Explanation -> 3rd row has maximum number of zeroes among all the rows
 * 
 */
public class FindRowWithMaxZeroes {
	...
	public static void main(String[] args) {
		...
		System.out.println((rowNumber + 1) + " row has maximum number of zeroes with count: " + maxZeroes);
	}
