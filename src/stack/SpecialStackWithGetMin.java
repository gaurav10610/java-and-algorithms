...
/**
 * 
 * Design a stack that supports all the below mentioned operations with expectd time complexity
 * 
 * 1. push() - O(1)
 * 
 * 2. pop() - O(1)
 ...
 * 5. getMin() - O(1)
 * 
 * NOTE - To implement above stack, you should only use standard Stack data structure and no other
...
class SpecialStack {
  ...
  /**
   * 
   * pushes an element in stack and returns true else return false if stack is already full
   */
  ...
  /**
   * 
   * removes element from top of the stack and return it else return null is stack is empty
   */
  public Integer pop() {
    if (isEmpty())
      return null;
